...
import useGetData from '../custom-hooks/useGetData';
 ...
 const ProductDetails = () => {
  ...
  useEffect(()=>{
    const docRef=doc(db,'bangles',id);
  ...
  useEffect(()=>{
    const docRef=doc(db,'bridals',id);
    ...
    useEffect(()=>{
      const docRef=doc(db,'customised',id);
  ...
  useEffect(()=>{
    const docRef=doc(db,'earrings',id);
...
useEffect(()=>{
  const docRef=doc(db,'fingerRings',id);
...
useEffect(()=>{
  const docRef=doc(db,'mangalsutras',id);
...
useEffect(()=>{
  const docRef=doc(db,'mangtikkas',id);
...
useEffect(()=>{
  const docRef=doc(db,'necklaces',id);
